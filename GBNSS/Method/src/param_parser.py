...
def parameter_parser():
    ...
    parser.add_argument("--training-graphs",
                        nargs="?",
                        default="/Method/dataset/data.csv",
	                help="Datasets for model GBNSS")
    ...
    parser.add_argument("--label",
                        nargs="?",
                        default="go",
                        help="Choosing a label to train. For biology, the label is go; for topology, the labels are EC, LCCS, S3")
    ...
    parser.add_argument("--batch-size",
                    type=int,
                    default=128,
                help="Number of graph pairs per batch. Default is 32.")
